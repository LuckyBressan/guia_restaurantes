...
@section('content')
    ...
    @foreach($cardapios as $cardapio)
        <div class="col">
            <div class="card mb-3 card-cardapio" style="max-width: 540px; max-height:162px">
                <div class="row g-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="acoes">
                                @if ((Auth::check()) && (Auth::user()->isAdmin()))
                                    ...
                                    {{Form::close()}}
                                    <a href="{{ url('cardapios/'.$cardapio->id.'/edit') }}" style="text-decoration: none; color:inherit;"><button class="editar">Editar</button></a>
                                @endif
                            </div>
                        </div>
                    </div>
